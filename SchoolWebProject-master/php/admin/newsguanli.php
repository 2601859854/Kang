...
$sql=mysqli_query($con,"select * from `news` order by 'id' desc");
$maxrows=mysqli_num_rows($sql);
$pagesize=5;
...
$sql2=mysqli_query($con,"select * from `news` order by `id` desc limit $start,$pagesize");
 ?>
